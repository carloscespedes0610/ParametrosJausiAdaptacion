...
{
    //------------------Parametros ----------------------------------------
    public static cFecha FechaMayor(DateTime fechaini, DateTime fechafin) {
        int res = fechaini.CompareTo(fechafin);
        return  res < 0 ? cFecha.Menor : res > 0 ? cFecha.Mayor : cFecha.Igual;
