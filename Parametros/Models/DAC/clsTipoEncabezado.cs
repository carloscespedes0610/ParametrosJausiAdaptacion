...
{
    public class clsTipoEncabezado : clsBase, IDisposable
    {
        private long mlngTipoEncabezadoId;
        private string mstrTipoEncabezadoDes;

        //******************************************************
        // Private Data To Match the Table Definition
        //******************************************************
        public long TipoEncabezadoId { get => mlngTipoEncabezadoId; set => mlngTipoEncabezadoId = value; }
        public string TipoEncabezadoDes { get => mstrTipoEncabezadoDes; set => mstrTipoEncabezadoDes = value; }
        ...
        //*
        //************************************************************
        public clsTipoEncabezado()
        {
            mstrTableName = "parTipoEncabezado";
            mstrClassName = "clsTipoEncabezado";

            PropertyInit();
            FilterInit();
        }

        public clsTipoEncabezado(string ConnectString) : this()
        {
        ...
        public clsTipoEncabezado(SqlConnection oConnection) : this()
        {
            moConnection = oConnection;
        }

        public clsTipoEncabezado(SqlConnection oConnection, SelectFilters bytSelectFilter) : this()
        {
            moConnection = oConnection;
            mintSelectFilter = bytSelectFilter;
        }

        public clsTipoEncabezado(SqlConnection oConnection, SelectFilters bytSelectFilter, WhereFilters bytWhereFilter) : this()
        {
            moConnection = oConnection;
            mintSelectFilter = bytSelectFilter;
        ...
        public clsTipoEncabezado(SqlConnection oConnection, SelectFilters bytSelectFilter, WhereFilters bytWhereFilter, OrderByFilters bytOrderByFilter) : this()
        {
            moConnection = oConnection;
            mintSelectFilter = bytSelectFilter;
            mintWhereFilter = bytWhereFilter;
        ...
        protected override void SelectParameter()
        {
            ...
            switch (mintSelectFilter)
            {
                case SelectFilters.All:
                    mstrStoreProcName = "parTipoEncabezadoSelect";
                    break;
        ...
        private void WhereParameter()
        {
            switch (mintWhereFilter)
            {
                case WhereFilters.PrimaryKey:
                    ...
                    moParameters[3] = new SqlParameter("@TipoEncabezadoId", mlngTipoEncabezadoId);
            ...
            switch (mintDeleteFilter)
            {
                case DeleteFilters.All:
                    ...
                    moParameters = new SqlParameter[2] {
                        ...
                        new SqlParameter("@PrefijoTipoId", mlngTipoEncabezadoId)};
                    break;
            }
        }
